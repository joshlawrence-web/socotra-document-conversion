...
once to register it with Codex — then you can convert HTML from any project directory
without keeping this repo open. See [README.md](README.md) § "Using with Codex".
